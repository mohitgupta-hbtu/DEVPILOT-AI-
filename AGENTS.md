...
- **Guiderails:** The Mentor Agent is strictly instructed to _**only**_ answer questions pertaining to the active repository. If a user asks "How do I bake a cake?", the Agent is instructed to politely refuse, maintaining professional system immersion.
